...
function page() {
    const arr=[
        {
            image:"https://cdn-ciobl.nitrocdn.com/SELEEFhgGIZTLBYDDcxxtVcKvWWxFmUU/assets/images/optimized/rev-ec522ac/www.cutislaserclinics.com/wp-content/uploads/2020/01/Sunscreen.jpg",
            ...
            heading:"Are You Using Sunscreen Right Way?",
            content:"One of the best preventive measures in your skin care toolbox is SUNSCREEN. But, to make sure that the sunscreen dose ...",
        },
        {
        ...
        },
        {
            ...
            content:"Flying off the handle over trifles can be easy. While family members might put up with your anger management problem, friends and work colleagues will definitely not.",
        },
        {
            ...
            content:"Childhood obesity is on the rise due to many factors like fast food, lack of physical activity.Symptoms include increased thirst, frequent urination, hunger, fatigue and blurred vision.",
        },
        {
            ...
            heading:"Pro Tips for Treating Male Pattern Baldness",
            content:"70% men globally suffer from the male pattern of balding and stress only worsens it. A receding hairline and loss of one's crowning glory can leave the strongest man helpless.",
        },
        {
            image:"https://images.pexels.com/photos/4506075/pexels-photo-4506075.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
            link:"https://www.harvardpilgrim.org/hapiguide/how-cold-weather-impacts-joint-pain/",
            heading:"How cold weather affects joint pain?",
            content:"When winter alarms triggers, the fear of winter frightens leaving people undelightful especially to the one who are already trapped ...",
        },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            {
                ...
                <div className="w-88 lg:w-96 rounded-md" key={index} style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
                    ...
                    <div className="m-3">
                        ...
                        <span className="flex mt-2"><AiOutlineLike className="h-6 w-6 mr-3"/><WhatsAppButton url={`${item.link}`} message={`${item.heading}`} /></span>
                    </div>
                </div>
                )
            }
