        ...
        <div className="grid grid-cols-1 sm:flex sm:justify-center p-3 gap-5 sm:gap-12 items-center pt-6 border-t-2 pb-6">
            <div className="sm:w-80">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                    <button onClick={handleArticlesClick} className="px-5 py-3 rounded-md text-sm font-semibold bg-sky-500 text-white">
                        See all Articles
                    </button>
                </div>
            </div>
            <div className="sm:w-96 p-3 rounded-md" style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
                <Image 
                    src="https://cdn-ciobl.nitrocdn.com/SELEEFhgGIZTLBYDDcxxtVcKvWWxFmUU/assets/images/optimized/rev-ec522ac/www.cutislaserclinics.com/wp-content/uploads/2020/01/Sunscreen.jpg" 
                    alt="Sunscreen" 
                    width={400} 
                    height={100} 
                />
                <div className="m-3">
                    <Link 
                        href="https://www.thehealthsite.com/beauty/skin-care/are-you-applying-your-sunscreen-the-right-way-heres-how-to-use-it-correctly-875927/" 
                        className="mt-2 text-xl font-bold hover:text-gray-600"
                    >
                        Are You Using Sunscreen Right Way?
                    </Link> 
